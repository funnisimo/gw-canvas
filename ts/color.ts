...
export class Color extends Int16Array {
  ...
  static make(arg?: ColorBase | null, base256 = false): Color {
  ...
  static from(...args: any[]): Color {
    ...
    if (arg < 0 || arg === undefined) return new this(-1);
    if (typeof arg === "string") {
      if (!arg.startsWith("#")) {
  ...
  static install(name: string, info: ColorBase) {
  ...
  static installSpread(name: string, base: ColorBase) {
